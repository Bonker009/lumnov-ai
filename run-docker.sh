...
start_services() {
    ...
    echo "   Frontend: http://203.255.78.58:9025"
    echo "   Backend API: http://203.255.78.58:9024"
    echo "   Swagger UI: http://203.255.78.58:9024/swagger-ui.html"
    echo "   Database: 203.255.78.58:9023"
}
